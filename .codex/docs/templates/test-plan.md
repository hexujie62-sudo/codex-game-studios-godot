...
*Results and sign-off are tracked in the QA sign-off report generated by `/smoke-check` — not in this plan file.*

*Template: `.codex/docs/templates/test-plan.md`*
*Generated by: `/smoke-check` — do not edit this line*
