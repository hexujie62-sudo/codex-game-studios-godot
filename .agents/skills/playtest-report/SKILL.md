...
description: "生成结构化的游戏测试报告模板或将现有游戏测试笔记分析为结构化格式。使用此功能来标准化游戏测试反馈的收集和分析。"
...
After categorising findings, spawn `creative-director` via Task using gate **CD-PLAYTEST** (`.codex/docs/director-gates.md`).
