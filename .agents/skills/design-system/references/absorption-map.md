...
| `propagate-design-change` | `references/system-index-patch-impact.md` | changed-GDD diff, ADR impact classifications, traceability update, change-impact output, non-destructive ADR status rule | old command framing and technical-director gate |
